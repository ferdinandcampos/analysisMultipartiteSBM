...
```{r plot functional cartography, eval=TRUE, fig.height=6, fig.width=6, fig.align="center"}
...
```{r plot block caracterisation distrib, eval=TRUE, fig.height=6, fig.width=8.5}
...
```{r plot block caracterisation mds, eval=TRUE, fig.height=6, fig.width=6}
