...
```{r plot block analysis, eval=TRUE, fig.height=5.5, fig.width=8.5}
...
```{r plot block caracterisation, eval=TRUE, fig.height=5.5, fig.width=8.5}
...
```{r plot functional cartography, eval=TRUE, fig.height=6, fig.width=6}
