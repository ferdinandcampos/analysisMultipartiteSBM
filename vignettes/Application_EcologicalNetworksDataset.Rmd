...
if (!study_insectes_only){analyse<-read.xlsx("data/analyse_réseaux_réels_6.xlsx",1, colNames= TRUE)
} else{analyse<-read.xlsx("data/analyse_réseaux_réels_8_all_insects.xlsx",1, colNames= TRUE)}
...
```{r plot block analysis, eval=FALSE}
