...
variables_to_Latex=function(variable){
  if (variable=="c_inter1"){latex_string=TeX(r'($\bar{c}_b$)')
  }else if (variable=="c_inter2"){latex_string=TeX(r'($\bar{c}_a$)')
  }else if (variable=="c_tot"){latex_string=TeX(r'($\bar{c}_{tot}$)')
  }else if (variable=="c_tot_sym"){latex_string=TeX(r'($\bar{c}_{tot}^{sym}$)')
  }else if (variable=="PR_inter1"){latex_string=TeX(r'($PR_b$)')
  }else if (variable=="PR_inter1_sym"){latex_string=TeX(r'($PR_b^{sym}$)')
  }else if (variable=="cKnn_inter1"){latex_string=TeX(r'($\bar{c}_b^{N}$)')
  }else if (variable=="cKnn_inter2"){latex_string=TeX(r'($\bar{c}_a^{N}$)')
  }else if (variable=="cKnn_tot"){latex_string=TeX(r'($\bar{c}_{tot}^{N}$)')
  }else if (variable=="PC1"){latex_string=TeX(r'($PCA_1$)')
  }else if (variable=="PC2"){latex_string=TeX(r'($PCA_2$)')
  }else if (variable=="PC3"){latex_string=TeX(r'($PCA_3$)')
  }else if (variable=="MDS1"){latex_string=TeX(r'($MDS_1$)')
  }else if (variable=="MDS2"){latex_string=TeX(r'($MDS_2$)')
  }else if (variable=="nb_herbi_clust"){latex_string=TeX(r'($K_a$)')
  }else if (variable=="nb_plants_clust"){latex_string=TeX(r'($K_l$)')
  }else if (variable=="nb_polli_clust"){latex_string=TeX(r'($K_b$)')
  }else if (variable=="cluster_pi_herbi"){latex_string=TeX(r'($\pi_k^a$)')
  }else if (variable=="cluster_pi_plants"){latex_string=TeX(r'($\pi_{k'}^l$)')
  }else if (variable=="cluster_pi_polli"){latex_string=TeX(r'($\pi_k^b$)')
  }else{latex_string="X"}
  return(latex_string)
}