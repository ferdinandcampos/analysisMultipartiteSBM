...
plotFunctionalCartography=function(analyse,
  ...
  values_colors<-rep("#000000",length(data_plants[[metrique_color]])) #NB si on modifie directement values colors en mettant des codes hexa au milieu des numeric ça pose souci. faire deux objets
